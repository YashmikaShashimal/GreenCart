...
const SellerLogin = () => {
  ...
  return !isSeller && (
    <form onSubmit={onSubmitHandler} className='flex min-h-screen items-center text-sm to-gray-600'>
    ...
    <div className='flex flex-col gap-5 m-auto items-start p-8 py-12 max-w-80 sm:min-w-88 rounded-lg shadow-xl border border-gray-200'>
      ...
      <button className='bg-primary to-white w-full py-2 rounded-md cursor-pointer'>Login</button>
    </div>
